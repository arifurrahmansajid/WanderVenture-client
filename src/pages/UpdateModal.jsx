...
const UpdateModal = ({ room, handleUpdate }) => {
    ...
    // Convert the bookingDate (if provided) to a Date object
    ...
    const handleUpdateDate = (e) => {
        e.preventDefault();
        // Use the current startDate value. Convert to ISO string if needed.
                ...
                <div className="-mx-2 md:items-center md:flex">
                    ...
                    <div className="flex-1 px-2">
                        ...
                        <DatePicker
                            ...
                            name="date"
                            className="block w-full px-5 py-2.5 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-lg dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40"
                        />
                    </div>
                </div>
